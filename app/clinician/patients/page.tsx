  ...
  return (
    <DashboardLayout userType="clinician">
      <div className="mb-6 md:mb-8">
        <h1 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">Manage Patients</h1>
        <p className="text-sm md:text-base text-slate-600 dark:text-slate-400 mt-1">View and manage your patient list</p>
      </div>

      <div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 overflow-hidden">
        {/* Toolbar */}
        <div className="p-4 md:p-6 border-b border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          ...
          <button className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors self-center">
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
              {patients.map((patient) => (
                ...
                >
                  ...
                  <td className="px-4 md:px-6 py-3 md:py-4 text-slate-600 dark:text-slate-400 text-sm whitespace-nowrap">{patient.age}</td>
                  <td className="px-4 md:px-6 py-3 md:py-4 font-medium text-slate-900 dark:text-white text-sm whitespace-nowrap">
                    {patient.bp}
                  </td>
                  <td className="px-4 md:px-6 py-3 md:py-4 whitespace-nowrap">
                    <span className={`px-2 md:px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(patient.status)}`}>
                      {patient.status}
                    </span>
                  </td>
