  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* This is what handles the sidebar gap on desktop - reserves space for the fixed sidebar */}
        <div
          className={cn(
            "relative h-full w-[--sidebar-width] shrink-0 bg-transparent transition-[width] duration-200 ease-linear",
